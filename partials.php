...
<link rel="icon" type="image/png" href="assets/logo_prime_single.png">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
<link rel="stylesheet" href="assets/vendor/swiper-bundle.min.css?v=<?=$assetVersion?>"><link rel="stylesheet" href="assets/style.css?v=<?=$assetVersion?>"><script>window.primeOrderingOpen=<?=prime_ordering_open()?'true':'false'?>;</script></head><body>
...
<header class="header"><a class="brand" href="index.php" aria-label="IMA PRIME - Trang chủ"><img src="assets/logo_prime_single.png" alt=""><span class="brand-copy"><span class="brand-name">IMA <em>PRIME</em></span><small>Sofa giường chỉnh điện</small></span></a><button class="menu-toggle" aria-label="Mở menu">☰</button><nav><a href="category.php">Sản phẩm</a><a href="fabric-library.php">Thư viện vải</a><a href="about.php">Về chúng tôi</a></nav><a class="zalo small" href="https://zalo.me/0934430111">Nhắn Zalo</a><button class="header-cart" type="button" data-cart-open aria-label="Giỏ hàng"><i class="bi bi-bag"></i><span data-cart-count>0</span></button></header><div class="cart-modal" data-cart-modal hidden><div class="cart-modal-backdrop" data-cart-close></div><section class="cart-modal-panel" role="dialog" aria-modal="true" aria-label="Giỏ hàng"><button class="cart-modal-close" data-cart-close aria-label="Đóng">×</button><div class="eyebrow">Giỏ hàng</div><h2>Sản phẩm bạn đang chọn</h2><div data-cart-preview></div><a class="button" href="cart.php">Đi đến giỏ hàng</a></section></div>
<?php }
